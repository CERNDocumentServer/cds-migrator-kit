...
def find_recids_comments(queries):
    recids_list = []
    print("Querying already migrated records...")
    for i, collection_query in enumerate(queries):
        recs = search_pattern(p=collection_query)
        print(
            "({} / {}) Found {} records for query `{}`".format(
                i + 1, len(queries), len(recs), collection_query
            )
        )
    ...
    return recids_with_comments


def dump_comments_and_users(recids):
    comments_metadata = {}
    """
    {
        recid: [
    ...
    return comments_metadata, users_metadata
...
def dump_users(users):
    ...
    valid_users, missing_users = _dump(users)
...
collection_queries = [
    '980:L3_Papers -690C_:SCICOM -980:SCICOMMPUBLLEPC -980:SCICOMMPUBLSPSC -595:PSARCHIVE -595:SPSARCHIVE -595:LEPARCHIVE -980:ANNOUNCEMENT -980:DELETED -980:HIDDEN -980__c:MIGRATED -980__a:DUMMY -690C_:movingimages -970__b:MERGE-* -980:INTNOTEALICEPUBL',
    '693__e:L3 -980:GREYBOOK -980:Press_Release -980:INTNOTECMSPUBL -980:ANNOUNCEMENT -690C_:SCICOM -980:SCICOMMPUBLLEPC -980:SCICOMMPUBLSPSC -595:PSARCHIVE -595:SPSARCHIVE -595:LEPARCHIVE -980:PHOTOLAB -980:PHOTOARC -980:VIDEOARC -980:DELETED -980:HIDDEN -980__c:MIGRATED -980__a:DUMMY -690C_:movingimages -970__b:MERGE-* -980:INTNOTEALICEPUBL',
    '980:L3_Misc -690C_:SCICOM -980:ANNOUNCEMENT -980:SCICOMMPUBLLEPC -980:SCICOMMPUBLSPSC -595:PSARCHIVE -595:SPSARCHIVE -595:LEPARCHIVE -980:DELETED -980:HIDDEN -980__c:MIGRATED -980__a:DUMMY -690C_:movingimages -970__b:MERGE-* -980:INTNOTEALICEPUBL',

    '693__e:OPAL -980:GREYBOOK -690C_:SCICOM -980:ANNOUNCEMENT -980:SCICOMMPUBLLEPC -980:SCICOMMPUBLSPSC -980:PHOTOLAB -980:PHOTOARC -980:VIDEOARC -595:PSARCHIVE -595:SPSARCHIVE -595:LEPARCHIVE -980:DELETED -980:HIDDEN -980__c:MIGRATED -980__a:DUMMY -690C_:movingimages -970__b:MERGE-*',

    '980:OPAL_Papers -690C_:SCICOM -980:ANNOUNCEMENT -980:SCICOMMPUBLSPSC -980:SCICOMMPUBLLEPC -595:PSARCHIVE -595:SPSARCHIVE -595:LEPARCHIVE -980:DELETED -980:HIDDEN -980__c:MIGRATED -980__a:DUMMY -690C_:movingimages -970__b:MERGE-*',

    '980:OPAL_Misc -690C_:SCICOM -980:ANNOUNCEMENT -980:SCICOMMPUBLSPSC -980:SCICOMMPUBLLEPC -595:PSARCHIVE -595:SPSARCHIVE -595:LEPARCHIVE -980:DELETED -980:HIDDEN -980__c:MIGRATED -980__a:DUMMY -690C_:movingimages -970__b:MERGE-*',

    '980:DELPHI_Misc -690C_:SCICOM -980:ANNOUNCEMENT -980:SCICOMMPUBLSPSC -980:SCICOMMPUBLLEPC -595:PSARCHIVE -595:SPSARCHIVE -595:LEPARCHIVE -980:DELETED -980:HIDDEN -980__c:MIGRATED -980__a:DUMMY -690C_:movingimages -970__b:MERGE-*',

    '980:DELPHI_Papers -690C_:SCICOM -980:ANNOUNCEMENT -980:SCICOMMPUBLSPSC -980:SCICOMMPUBLLEPC -595:PSARCHIVE -595:SPSARCHIVE -595:LEPARCHIVE -980:DELETED -980:HIDDEN -980__c:MIGRATED -980__a:DUMMY -690C_:movingimages -970__b:MERGE-*',

    '690:PUBLDELPHINOTE -690C_:SCICOM -980:ANNOUNCEMENT -980:SCICOMMPUBLSPSC -980:SCICOMMPUBLLEPC -595:PSARCHIVE -595:SPSARCHIVE -595:LEPARCHIVE -980:DELETED -980:HIDDEN -980__c:MIGRATED -980__a:DUMMY -690C_:movingimages -970__b:MERGE-*',

    '690:PRIVDELPHINOTE -690C_:SCICOM -980:ANNOUNCEMENT -980:SCICOMMPUBLSPSC -980:SCICOMMPUBLLEPC -595:PSARCHIVE -595:SPSARCHIVE -595:LEPARCHIVE -980:DELETED -980:HIDDEN -980__c:MIGRATED -980__a:DUMMY -690C_:movingimages -970__b:MERGE-*',

    '980:INTNOTEALEPHPRIV -690C_:SCICOM -980:ANNOUNCEMENT -980:SCICOMMPUBLSPSC -980:SCICOMMPUBLLEPC -595:PSARCHIVE -595:SPSARCHIVE -595:LEPARCHIVE -980:DELETED -980:HIDDEN -980__c:MIGRATED -980__a:DUMMY -690C_:movingimages -970__b:MERGE-* -980:ALEPHDRAFT',

    '037:CERN-ALEPH-PUB* -690C_:SCICOM -980:ANNOUNCEMENT -980:SCICOMMPUBLLEPC -980:SCICOMMPUBLSPSC -595:PSARCHIVE -595:SPSARCHIVE -595:LEPARCHIVE -980:DELETED -980:HIDDEN -980__c:MIGRATED -980__a:DUMMY -690C_:movingimages -970__b:MERGE-* -980:ALEPHDRAFT',

    '710:"ALEPH Collaboration" -690C_:SCICOM -980:ANNOUNCEMENT -980:SCICOMMPUBLLEPC -980:SCICOMMPUBLSPSC -595:PSARCHIVE -595:SPSARCHIVE -595:LEPARCHIVE -980:DELETED -980:HIDDEN -980__c:MIGRATED -980__a:DUMMY -690C_:movingimages -970__b:MERGE-* -980:ALEPHDRAFT',

    '980:ALEPHDRAFT -980:DELETED -980:HIDDEN -980__c:MIGRATED -980__a:DUMMY -690C_:movingimages -970__b:MERGE-*',

    '037:CERN-ALEPH-ARCH-DATA* -690C_:SCICOM -980:ANNOUNCEMENT -980:SCICOMMPUBLLEPC -980:SCICOMMPUBLSPSC -595:PSARCHIVE -595:SPSARCHIVE -595:LEPARCHIVE -980:DELETED -980:HIDDEN -980__c:MIGRATED -980__a:DUMMY -690C_:movingimages -970__b:MERGE-* -980:ALEPHDRAFT',

    '693__e:DELPHI -690:PRIVDELPHINOTE -980:GREYBOOK -980:LHCb_Misc -690C_:SCICOM -980:ANNOUNCEMENT -980:SCICOMMPUBLLEPC -980:SCICOMMPUBLSPSC -980:PHOTOLAB -980:PHOTOARC -980:VIDEOARC -595:PSARCHIVE -595:SPSARCHIVE -595:LEPARCHIVE -980:DELETED -980:HIDDEN -980__c:MIGRATED -980__a:DUMMY -690C_:movingimages -970__b:MERGE-*'

]

recids_with_comments = find_recids_comments(collection_queries)
comments, users = dump_comments_and_users(recids_with_comments)
dump_users(users)
