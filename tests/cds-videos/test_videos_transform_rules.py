...
def get_dump_revision(entry_data, migrator_model=videos_migrator_marc21):
...
def test_transform_description(datadir, base_app):
    ...
    with base_app.app_context():
        ...
        res = get_dump_revision(modified_data)
...
def test_transform_digitized(datadir, base_app):
    ...
    with base_app.app_context():
        ...
        entry_data = data[1]
        res = get_dump_revision(entry_data)
