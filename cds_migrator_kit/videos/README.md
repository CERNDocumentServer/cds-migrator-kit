...
- `MOUNTED_MASTER_CEPH_PATH`
- `MOUNTED_MEDIA_CEPH_PATH`

## Master Path

- The master path should contain the original files.
- If a record has both presenter and presentation files, they should be named as:

  - `presenter.mp4` / `presentation.mp4` or
  - `camera.mp4` / `slides.mp4`

- If a record has only one video, it should be named as:
