...
class CDSVideosLoad(Load):
    ...
    def _after_publish_mint_recid(self, record_uuid, entry):
    ...
    def _after_publish(self, published_record, entry):
        ...
        # Mint legacy recid
        self._after_publish_mint_recid(record_uuid, entry)
        db.session.commit()
    ...
    def _get_submitter(self, entry):
        ...
        elif submitter_id == "system":
            raise ManualImportRequired(f"No system user found", stage="load")
        return submitter
