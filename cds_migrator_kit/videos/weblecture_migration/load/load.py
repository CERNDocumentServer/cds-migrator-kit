...
class CDSVideosLoad(Load):
    ...
    def create_publish_single_video_record(self, entry):
        ...
        additional_files = [
            "cds_migrator_kit/videos/weblecture_migration/data/additional/217490_medium.mp4",
            "cds_migrator_kit/videos/weblecture_migration/data/additional/0810023_01.jpg",
            "cds_migrator_kit/videos/weblecture_migration/data/additional/subtitle_fr.vtt",
            "cds_migrator_kit/videos/weblecture_migration/data/additional/poster.jpg",
        ]
        load_additional_files(str(bucket_id), additional_files)
    ...
    def _run_flow(self, object_version, deposit_id):
        ...
        # Load the subformats
        subformat_paths = [
            "cds_migrator_kit/videos/weblecture_migration/data/videos/test_video-360p-quality.mp4"
        ]
