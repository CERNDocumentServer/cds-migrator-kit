...
class TransformFiles:
    ...
    def _frames_exists(self, frames_list):
        ...
        # TODO should we generate the frames if missing or more than 10?
    ...
    def _get_highest_and_other_composites(self):
        ...
        other_composites = [composite_videos[res] for res in [720, 480, 360] if res in composite_videos]
    ...
    def _set_media_files(self, files_paths):
        ...
        # We dont have the composite we'll get the subformats and frames from the folder
            ...
            subformats_list = [file_path for file_path in subformats if not self.transformed_files_json["master_video"].endswith(Path(file_path).name)]
