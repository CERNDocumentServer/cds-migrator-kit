...
class SubmitterModel(CdsOverdo):
    ...
    __ignore_keys__ = {
        ...
        "245__9",
        "999C59",
        "0247_2",  # 242 -> subtitle translation
        ...
        "925__b",
        "852__a",
        "541__a",  # restricted record ! 1655788 (location?) check with IT secretary?
        ...
        "856__y",
        "856__a",  # seems like an url, but missing ind=4
        ...
        "6351_9",
        "6351_a",  # 1375850  subjects TODO
        "916__d",  # 325944 not sure the meaning of the number
        "6532_a",
        "6532_9",  # look like subjects but seems a wrong field, 1341864
        "037__z",  # 1538525 report number in a wrong subfield
        "540__g",
        "540__f",  # looks like license and funding info?
        ...
        "520__F",
        "520__ ",  # $$ breaking 1607078, 2790972
        "590__a",  # abstract translation TODO 1476067
        "520__y",  # 2053769 $$ broken, 1969601, 2102935
        "653__a",
        "653__9",  # 2263131 strange keyword scheme 2283139, 1464084
        ...
        "701_aa",
        "701_ae",
        "701_au",  # 2690834 wrong subfield ind
        "852__a",  # locatoin, cern libary # TODO 366331, 366497
        "8564_a",
        "8546_a",  # 2802982
        "035__p",  # 2859334 should be ID scheme, not provenance
        "246__n",
        "246__p",  # check ILS fields 968697 # TODO
        "65917a",
        "659172",  # subjects, TODO check 1198225
        "999C52",  # 2640188
        ...
        "775__w",
        "775__b",  # 1528167 # TODO related document
        "999C5v",  # 2283088
        "697C_a",  # 120467 ILS record
        "560172",
        "56017a",  # 383486 wrong keyword subfield
        "8565_y",
        "8565_u",  # 2284218 wrong url field
        "520__^",
        "520___",  # 2710229 $$ broken
